...
def run(opt=None):
    ...
    #################### DATALOADER SETUPS ##################
    dataloaders = {}
    datasets    = dataset_module.select(opt.dataset, opt, opt.source_path)
    ...
    metric_computer = metric_module.MetricComputer(opt.evaluation_metrics, opt)
...
if __name__ == '__main__':
    ...
    opt.source_path = root_dataset
    opt.save_path   = root_output
